...
if selected == "Modify":
    ...
    st.title(":violet[Modify or Delete the data here]")
    ...
    if st.button("View Updated Data"):
        suresh.execute("select CompanyName, CardHolder, Designation, MobileNumber, Email, Website, Area, City, State, PinCode from business_cards")
        updated_df = pd.DataFrame(suresh.fetchall(),columns=["CompanyName", "CardHolder", "Designation", "MobileNumber", "Email", "Website", "Area", "City", "State", "PinCode"])
        st.write(updated_df)